          ...
          {availableRoles.map(roleKey => {
            ...
            return (
              <div
                ...
                className={`bg-gray-800 rounded-2xl p-6 md:p-8 border border-gray-700 ${config.hover} transform hover:-translate-y-2 transition-all duration-300 cursor-pointer flex flex-col items-center text-center`}
              >
                <div className="bg-gray-700/50 p-3 md:p-4 rounded-full mb-4 md:mb-6">
                  <config.Icon className={`w-10 h-10 md:w-12 md:h-12 ${config.color}`} />
                </div>
